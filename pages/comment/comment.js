...
Page({
  ...
  onShareAppMessage: function () {
    ...
    return {
      title: 'Discovery',
      path: '/pages/comment/comment?discovery_id=' + that.data.original_discovery_id + '&avatarUrl=' + that.data.avatarUrl + '&time=' + that.data.time + '&nickname=' + that.data.nickname + '&content=' + that.data.content + '&user_id=' + that.data.user_id
    }
  },
